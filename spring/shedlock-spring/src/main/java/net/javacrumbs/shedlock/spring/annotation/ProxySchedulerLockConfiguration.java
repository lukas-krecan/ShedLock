...
class ProxySchedulerLockConfiguration implements ImportAware {
    private AnnotationAttributes annotationAttributes;

    @Bean
    @Role(BeanDefinition.ROLE_INFRASTRUCTURE)
    ProxyScheduledLockAopBeanPostProcessor proxyScheduledLockAopBeanPostProcessor() {
        return new ProxyScheduledLockAopBeanPostProcessor(annotationAttributes.getString("defaultLockAtMostFor"), annotationAttributes.getString("defaultLockAtLeastFor"));
    }
