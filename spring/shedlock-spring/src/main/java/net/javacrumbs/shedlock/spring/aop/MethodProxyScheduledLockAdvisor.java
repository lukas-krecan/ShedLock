...
class MethodProxyScheduledLockAdvisor extends AbstractPointcutAdvisor {
    ...
    MethodProxyScheduledLockAdvisor(
            ...
            @Nullable LockingTaskExecutorListener listener) {
        this.advice = new LockingInterceptor(lockConfigurationExtractor, lockProviderSupplier, listener);
    }
    ...
    private static class LockingInterceptor implements MethodInterceptor {
        ...
        private final @Nullable LockingTaskExecutorListener listener;
        ...
        public @Nullable Object invoke(MethodInvocation invocation) throws Throwable {
            ...
            DefaultLockingTaskExecutor lockingTaskExecutor = listener != null
