...
public class DynamoDBUtils {
    ...
    public static Table createLockTable(
        ...
        CreateTableRequest request = new CreateTableRequest()
                ...
                .withKeySchema(new KeySchemaElement(DynamoDBLockProvider.ID, KeyType.HASH))
                .withAttributeDefinitions(new AttributeDefinition(DynamoDBLockProvider.ID, ScalarAttributeType.S))
