...
class OpenSearchLockProviderSnakeCaseTest {
    ...
    void setUp() {
        ...
        lockProvider = new OpenSearchLockProvider(OpenSearchLockProvider.Configuration.builder()
