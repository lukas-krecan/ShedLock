...
import net.javacrumbs.shedlock.test.support.jdbc.AbstractPostgres9JdbcLockProviderIntegrationTest;
...
public class Postgres9JdbcTemplateLockProviderIntegrationTest extends AbstractPostgres9JdbcLockProviderIntegrationTest {
    @Override
