 ...
 */
package net.javacrumbs.shedlock.provider.jdbctemplatepostgres;
 ...
 * <ol>
 * <li>
 * In this implementation, dedicated to Postgres database, the upsert feature is used, to reduce the number of logs in the database.
 ...
 * </ol>
 */
public class JdbcTemplatePostgresLockProvider extends StorageBasedLockProvider {

    private static final String DEFAULT_TABLE_NAME = "shedlock";

    public JdbcTemplatePostgresLockProvider(@NotNull JdbcTemplate jdbcTemplate) {
        this(jdbcTemplate, (PlatformTransactionManager) null);
    }

    public JdbcTemplatePostgresLockProvider(@NotNull JdbcTemplate jdbcTemplate, @Nullable PlatformTransactionManager transactionManager) {
        this(jdbcTemplate, transactionManager, DEFAULT_TABLE_NAME);
    }

    public JdbcTemplatePostgresLockProvider(@NotNull JdbcTemplate jdbcTemplate, @NotNull String tableName) {
        this(jdbcTemplate, null, tableName);
    }

    public JdbcTemplatePostgresLockProvider(@NotNull DataSource dataSource) {
        this(new JdbcTemplate(dataSource));
    }

    public JdbcTemplatePostgresLockProvider(@NotNull DataSource dataSource, @NotNull String tableName) {
        this(new JdbcTemplate(dataSource), tableName);
    }

    public JdbcTemplatePostgresLockProvider(@NotNull JdbcTemplate jdbcTemplate, @Nullable PlatformTransactionManager transactionManager, @NotNull String tableName) {
    ...
    public JdbcTemplatePostgresLockProvider(@NotNull Configuration configuration) {
        super(new JdbcTemplatePostgresStorageAccessor(configuration));
    }
    ...
    public static class Configuration {
        ...
        public static class Builder {
            ...
            public JdbcTemplatePostgresLockProvider.Configuration build() {
                return new JdbcTemplatePostgresLockProvider.Configuration(jdbcTemplate, transactionManager, tableName, timeZone, columnNames, lockedByValue);
            }
        }
