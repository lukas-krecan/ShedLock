 ...
 *
 * <p><b>Note:</b> This class is mirrored in the OpenSearch provider module.
 * When making changes, ensure both versions remain synchronized:
 * {@code shedlock-provider-opensearch-java/src/main/java/.../DocumentFieldNames.java}
 *
...
public record DocumentFieldNames(String name, String lockUntil, String lockedAt, String lockedBy) {
     ...
     * Use this when your ElasticsearchClient is configured with a JsonpMapper using SNAKE_CASE naming strategy.
     */
